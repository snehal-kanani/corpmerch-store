...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, q as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, t as lookupResultToBuffer, v as RequestStatusResponseStatus, U as UnknownError, w as RequestStatusDoneNoReplyErrorCode, x as RejectError, y as CertifiedRejectErrorCode, z as UNREACHABLE_ERROR, I as InputError, A as InvalidReadStateRequestErrorCode, B as ReadRequestType, D as Principal, F as IDL, G as MissingCanisterIdErrorCode, H as HttpAgent, J as encode, Q as QueryResponseStatus, K as UncertifiedRejectErrorCode, N as isV3ResponseBody, O as isV2ResponseBody, V as UncertifiedRejectUpdateErrorCode, W as UnexpectedErrorCode, X as decode, i as Subscribable, Y as pendingThenable, Z as resolveEnabled, s as shallowEqualObjects, _ as resolveStaleTime, o as noop, $ as environmentManager, a0 as isValidTimeout, a1 as timeUntilStale, a2 as timeoutManager, a3 as focusManager, a4 as fetchState, a5 as replaceData, n as notifyManager, r as reactExports, p as shouldThrowError, m as useQueryClient, a6 as useInternetIdentity, a7 as createActorWithConfig, a8 as Variant, a9 as Record, aa as Opt, ab as Service, ac as Func, ad as Vec, ae as Text, af as Nat, ag as Null, ah as Float64, ai as Bool, aj as Int, R as React } from "./index-BoS_c9l9.js";
...
const AdminLoginResult = Variant({
  "ok": Text,
  "err": Text
});
const ContactId = Nat;
...
const UpdateProductInput = Record({
  "id": ProductId,
  "featured": Bool,
  "stockQty": Nat,
  "name": Text,
...
Service({
  "addProduct": Func([Text, CreateProductInput], [Product], []),
  "adminLogin": Func([Text, Text], [AdminLoginResult], []),
  "deleteProduct": Func([Text, ProductId], [Bool], []),
  ...
  "updateProduct": Func([Text, UpdateProductInput], [Bool], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const AdminLoginResult2 = IDL2.Variant({ "ok": IDL2.Text, "err": IDL2.Text });
  ...
  const UpdateProductInput2 = IDL2.Record({
    "id": ProductId2,
    "featured": IDL2.Bool,
    "stockQty": IDL2.Nat,
    "name": IDL2.Text,
  ...
  return IDL2.Service({
    "addProduct": IDL2.Func([IDL2.Text, CreateProductInput2], [Product2], []),
    "adminLogin": IDL2.Func([IDL2.Text, IDL2.Text], [AdminLoginResult2], []),
    "deleteProduct": IDL2.Func([IDL2.Text, ProductId2], [IDL2.Bool], []),
    ...
    "updateProduct": IDL2.Func([IDL2.Text, UpdateProductInput2], [IDL2.Bool], [])
  });
};
...
class Backend {
  ...
  async listContactSubmissions(arg0) {
    if (this.processError) {
      try {
...
function from_candid_AdminLoginResult_n9(_uploadFile, _downloadFile, value) {
...
function from_candid_variant_n8(_uploadFile, _downloadFile, value) {
  return "bag" in value ? "bag" : "cap" in value ? "cap" : "tshirt" in value ? "tshirt" : value;
}
...
function to_candid_CreateProductInput_n1(_uploadFile, _downloadFile, value) {
  return to_candid_record_n2(_uploadFile, _downloadFile, value);
}
function to_candid_ProductFilter_n12(_uploadFile, _downloadFile, value) {
  return to_candid_record_n13(_uploadFile, _downloadFile, value);
}
function to_candid_SortOrder_n14(_uploadFile, _downloadFile, value) {
  return to_candid_variant_n15(_uploadFile, _downloadFile, value);
}
function to_candid_UpdateProductInput_n17(_uploadFile, _downloadFile, value) {
